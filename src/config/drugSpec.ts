...
export const DRUG_SPEC_DB: Record<string, {
  ...
  perUnitDose?: number; // 每单位剂量（mg/ml等），可选
  source?: string;    // 数据来源
}> = {
  // ========== 丸剂 ==========
  '麝香保心丸': { perBox: 42, unit: '丸', source: 'known' },
  '复方丹参滴丸': { perBox: 180, unit: '丸', source: 'known' },
  '银杏叶滴丸': { perBox: 80, unit: '丸', source: 'known' },
  '血塞通滴丸': { perBox: 90, unit: '丸', source: 'known' },
  '通脉滴丸': { perBox: 180, unit: '丸', source: 'known' },
  '六味地黄丸': { perBox: 360, unit: '丸', source: 'calculated' },
  '安脑丸': { perBox: 6, unit: '丸', source: 'known' },
  '芪苈强心胶囊': { perBox: 36, unit: '粒', source: 'known' },
  
  // ========== 片剂 ==========
  '阿司匹林': { perBox: 30, unit: '片', source: 'known' },
  '阿司匹林肠溶片': { perBox: 30, unit: '片', source: 'known' },
  ...
  '二甲双胍缓释片': { perBox: 30, unit: '片', source: 'known' },
  '格列美脲': { perBox: 60, unit: '片', source: 'known' },
  '辛伐他汀': { perBox: 7, unit: '片', source: 'known' },
  '氨氯地平': { perBox: 7, unit: '片', source: 'known' },
  '苯磺酸氨氯地平': { perBox: 28, unit: '片', source: 'known' },
  '苯磺酸左旋氨氯地平': { perBox: 28, unit: '片', source: 'known' },
  '替米沙坦': { perBox: 28, unit: '片', source: 'known' },
  '厄贝沙坦': { perBox: 14, unit: '片', source: 'known' },
  '厄贝沙坦氢氯噻嗪': { perBox: 14, unit: '片', source: 'known' },
  '缬沙坦': { perBox: 7, unit: '片', source: 'known' },
  '缬沙坦氨氯地平': { perBox: 7, unit: '片', source: 'known' },
  '缬沙坦氢氯噻嗪': { perBox: 14, unit: '片', source: 'known' },
  '培哚普利': { perBox: 10, unit: '片', source: 'known' },
  '富马酸比索洛尔': { perBox: 10, unit: '片', source: 'known' },
  '美托洛尔': { perBox: 20, unit: '片', source: 'known' },
  '琥珀酸美托洛尔': { perBox: 100, unit: '片', source: 'known' },
  '阿托伐他汀': { perBox: 7, unit: '片', source: 'known' },
  '瑞舒伐他汀': { perBox: 7, unit: '片', source: 'known' },
  '匹伐他汀': { perBox: 7, unit: '片', source: 'known' },
  '阿卡波糖': { perBox: 30, unit: '片', source: 'known' },
  ...
  '甘精胰岛素': { perBox: 1, unit: '支', source: 'known' },
  '精蛋白人胰岛素': { perBox: 1, unit: '支', source: 'known' },
  '地塞米松': { perBox: 1, unit: '支', source: 'known' },
  '呋塞米': { perBox: 1, unit: '支', source: 'known' },
